...
static std::string const __str_literal_1("Read address  %d", 16u);
static std::string const __str_literal_2("Response data  %d ", 18u);
static std::string const __str_literal_3("Response data %d ", 17u);
static std::string const __str_literal_5("Write Data %d \n", 15u);
static std::string const __str_literal_4("Write address %d", 16u);
...
void MOD_mkAXIConverter_tb::init_symbols_0()
{
  ...
  init_symbol(&symbols[1u], "b__h9181", SYM_DEF, &DEF_b__h9181, 8u);
...
{
  tUInt64 DEF_araddr__h7128;
  tUInt64 DEF_x_wget__h700;
  DEF_x_wget__h700 = INST_m_rd_araddrOut.METH_wget();
  DEF_araddr__h7128 = INST_m_rd_araddrOut.METH_whas() ? DEF_x_wget__h700 : 0llu;
  INST_axi_convert.METH_slave_read_fab_paraddr(DEF_araddr__h7128);
}
...
{
  tUInt64 DEF_x1__h7196;
  DEF_x1__h7196 = INST_axi_convert.METH_slave_read_fab_rdata();
  INST_m_rd_rdataIn.METH_wset(DEF_x1__h7196);
}
...
{
  tUInt64 DEF_awaddr__h7310;
  tUInt64 DEF_x_wget__h2654;
  DEF_x_wget__h2654 = INST_m_wr_awaddrOut.METH_wget();
  DEF_awaddr__h7310 = INST_m_wr_awaddrOut.METH_whas() ? DEF_x_wget__h2654 : 0llu;
  INST_axi_convert.METH_slave_write_fab_pawaddr(DEF_awaddr__h7310);
}
...
{
  tUInt64 DEF_wdata__h7378;
  tUInt64 DEF_x_wget__h3009;
  DEF_x_wget__h3009 = INST_m_wr_wdataOut.METH_wget();
  DEF_wdata__h7378 = INST_m_wr_wdataOut.METH_whas() ? DEF_x_wget__h3009 : 0llu;
  INST_axi_convert.METH_slave_write_fab_pwdata(DEF_wdata__h7378);
}

void MOD_mkAXIConverter_tb::RL_forward8_1()
{
  tUInt8 DEF_wstrb__h7398;
  tUInt8 DEF_x_wget__h3081;
  DEF_x_wget__h3081 = INST_m_wr_wstrbOut.METH_wget();
  DEF_wstrb__h7398 = INST_m_wr_wstrbOut.METH_whas() ? DEF_x_wget__h3081 : (tUInt8)0u;
  INST_axi_convert.METH_slave_write_fab_pwstrb(DEF_wstrb__h7398);
}
...
{
  tUInt64 DEF_x1__h7536;
  DEF_x1__h7536 = INST_axi_convert.METH_master_read_fab_araddr();
  INST_s_rd_araddrIn.METH_wset(DEF_x1__h7536);
}
...
{
  tUInt64 DEF_rdata__h7596;
  tUInt64 DEF_x_wget__h4366;
  DEF_x_wget__h4366 = INST_s_rd_rdataOut.METH_wget();
  DEF_rdata__h7596 = INST_s_rd_rdataOut.METH_whas() ? DEF_x_wget__h4366 : 0llu;
  INST_axi_convert.METH_master_read_fab_prdata(DEF_rdata__h7596);
}
...
{
  tUInt64 DEF_x1__h7717;
  DEF_x1__h7717 = INST_axi_convert.METH_master_write_fab_awaddr();
  INST_s_wd_awaddrIn.METH_wset(DEF_x1__h7717);
}
...
{
  tUInt64 DEF_x1__h7776;
  DEF_x1__h7776 = INST_axi_convert.METH_master_write_fab_wdata();
  INST_s_wd_wdataIn.METH_wset(DEF_x1__h7776);
}

void MOD_mkAXIConverter_tb::RL_forward8_3()
{
  tUInt8 DEF_x1__h7792;
  DEF_x1__h7792 = INST_axi_convert.METH_master_write_fab_wstrb();
  INST_s_wd_wstrbIn.METH_wset(DEF_x1__h7792);
}
...
{
  tUInt8 DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_32___d189;
  tUInt8 DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_56___d200;
  tUInt8 DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_16___d187;
  tUInt8 DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_24___d188;
  tUInt8 DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_8___d186;
  tUInt8 DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_0___d185;
  tUInt8 DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_48___d199;
  tUInt8 DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_40___d198;
  tUInt8 DEF_x__h8037;
  ...
  DEF_s_rd_in_rv_port1__read__77_BITS_66_TO_3___d183 = primExtract64(64u,
								     ...
								     32u,
								     3u);
  DEF_x__h8037 = DEF_s_rd_in_rv_port1__read____d177.get_bits_in_word8(0u, 3u, 6u);
  switch (DEF_x__h8037) {
  case (tUInt8)0u:
  ...
  DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_40___d198 = DEF_x__h8037 == (tUInt8)40u;
  DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_48___d199 = DEF_x__h8037 == (tUInt8)48u;
  DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_0___d185 = DEF_x__h8037 == (tUInt8)0u;
  DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_8___d186 = DEF_x__h8037 == (tUInt8)8u;
  DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_24___d188 = DEF_x__h8037 == (tUInt8)24u;
  DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_56___d200 = DEF_x__h8037 == (tUInt8)56u;
  DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_16___d187 = DEF_x__h8037 == (tUInt8)16u;
  DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_32___d189 = DEF_x__h8037 == (tUInt8)32u;
  DEF__dfoo1 = (DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_0___d185 || (DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_8___d186 || (DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_16___d187 || (DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_24___d188 || DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_32___d189)))) || (DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_40___d198 || (DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_48___d199 || DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_56___d200));
  DEF__0_CONCAT_DONTCARE___d8.set_bits_in_word(UWide_literal_68_h2aaaaaaaaaaaaaaaa.get_bits_in_word8(2u,
												     0u,
												     4u),
					       2u,
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    if (DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_0___d185)
      dollar_display(sim_hdl, this, "s,64", &__str_literal_2, 10llu);
    if (DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_8___d186)
      dollar_display(sim_hdl, this, "s,64", &__str_literal_3, 20llu);
    if (DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_16___d187)
      dollar_display(sim_hdl, this, "s,64", &__str_literal_3, 30llu);
    if (DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_24___d188)
      dollar_display(sim_hdl, this, "s,64", &__str_literal_3, 40llu);
    if (DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_32___d189)
      dollar_display(sim_hdl, this, "s,64", &__str_literal_3, 50llu);
    if (DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_40___d198)
      dollar_display(sim_hdl, this, "s,64", &__str_literal_3, 60llu);
    if (DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_48___d199)
      dollar_display(sim_hdl, this, "s,64", &__str_literal_3, 70llu);
    if (DEF_s_rd_in_rv_port1__read__77_BITS_8_TO_3_84_EQ_56___d200)
      dollar_display(sim_hdl, this, "s,64", &__str_literal_3, 80llu);
  }
}
...
{
  DEF_b__h9181 = INST_testState.METH_read();
  DEF_testState_12_PLUS_1___d215 = (tUInt8)255u & (DEF_b__h9181 + (tUInt8)1u);
...
void MOD_mkAXIConverter_tb::RL_read_register13()
{
  ...
  DEF_b__h9181 = INST_testState.METH_read();
  DEF_v__h9577 = primExtract64(64u, 67u, DEF_m_rd_out_rv_port1__read____d226, 32u, 65u, 32u, 2u);
  DEF_testState_12_PLUS_1___d215 = (tUInt8)255u & (DEF_b__h9181 + (tUInt8)1u);
  DEF__0_CONCAT_DONTCARE___d77.set_bits_in_word(UWide_literal_67_h2aaaaaaaaaaaaaaaa.get_bits_in_word8(2u,
												      0u,
												      3u),
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
    dollar_display(sim_hdl, this, "s,64", &__str_literal_6, DEF_v__h9577);
  INST_testState.METH_write(DEF_testState_12_PLUS_1___d215);
}
...
unsigned int MOD_mkAXIConverter_tb::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "b__h9181", 8u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "v__h9577", 64u);
...
void MOD_mkAXIConverter_tb::vcd_defs(tVCDDumpType dt, MOD_mkAXIConverter_tb &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.DEF__dfoo2 = DEF__dfoo2;
      ...
      ++num;
      if ((backing.DEF_b__h9181) != DEF_b__h9181)
      {
	vcd_write_val(sim_hdl, num, DEF_b__h9181, 8u);
	backing.DEF_b__h9181 = DEF_b__h9181;
      }
      ++num;
	...
	backing.DEF_testState_12_PLUS_1___d215 = DEF_testState_12_PLUS_1___d215;
      ...
      ++num;
      if ((backing.DEF_v__h9577) != DEF_v__h9577)
      {
	vcd_write_val(sim_hdl, num, DEF_v__h9577, 64u);
	backing.DEF_v__h9577 = DEF_v__h9577;
      }
      ++num;
    }
    else
