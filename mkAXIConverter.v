...
//
// On Sun Dec 27 06:25:59 UTC 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkAXIConverter(aclk,
  ...
  wire [63 : 0] addr__h6339, addr__h6619, x__h6455, x__h6820;
  ...
  assign WILL_FIRE_RL_writeRequest =
	     master_write_in$FULL_N && buffer$EMPTY_N &&
	     start_write_request &&
  ...
  assign ddr_write_count$D_IN =
	     (ddr_write_count == 64'd98304) ? 64'd0 : x__h6820 ;
  ...
  // submodule master_write_in
  assign master_write_in$D_IN = { addr__h6619, buffer$D_OUT, 11'd2040 } ;
  ...
  assign addr__h6619 = address_image_2 + ddr_write_count ;
  assign x__h6455 = ddr_read_count + 64'd8 ;
  assign x__h6820 = ddr_write_count + 64'd8 ;
