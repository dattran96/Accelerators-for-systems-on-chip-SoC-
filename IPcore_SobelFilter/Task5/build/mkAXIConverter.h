...
class MOD_mkAXIConverter : public Module {
 ...
 public:
  ...
  MOD_Reg<tUInt32> INST_bufferRowCount;
  MOD_Fifo<tUInt8> INST_buffer_8bit;
  MOD_Fifo<tUInt64> INST_buffer_out;
  ...
  MOD_Reg<tUInt8> INST_enq_order;
  MOD_Reg<tUInt32> INST_gray_data;
  MOD_Reg<tUInt8> INST_gx_reg11;
  MOD_Reg<tUInt8> INST_gx_reg12;
  MOD_Reg<tUInt8> INST_gx_reg13;
  MOD_Reg<tUInt8> INST_gx_reg21;
  MOD_Reg<tUInt8> INST_gx_reg22;
  MOD_Reg<tUInt8> INST_gx_reg23;
  MOD_Reg<tUInt8> INST_gx_reg31;
  MOD_Reg<tUInt8> INST_gx_reg32;
  MOD_Reg<tUInt8> INST_gx_reg33;
  MOD_Reg<tUInt8> INST_gy_reg11;
  MOD_Reg<tUInt8> INST_gy_reg12;
  MOD_Reg<tUInt8> INST_gy_reg13;
  MOD_Reg<tUInt8> INST_gy_reg21;
  MOD_Reg<tUInt8> INST_gy_reg22;
  MOD_Reg<tUInt8> INST_gy_reg23;
  MOD_Reg<tUInt8> INST_gy_reg31;
  MOD_Reg<tUInt8> INST_gy_reg32;
  MOD_Reg<tUInt8> INST_gy_reg33;
  MOD_Reg<tUInt32> INST_image_length;
  MOD_Reg<tUInt64> INST_image_size;
  MOD_Reg<tUInt32> INST_kernel_size;
  ...
  MOD_Reg<tUInt8> INST_outPixel;
  MOD_Reg<tUInt8> INST_out_count;
  MOD_Reg<tUInt64> INST_out_hold;
  MOD_Reg<tUInt8> INST_reg11;
  MOD_Reg<tUInt8> INST_reg12;
  MOD_Reg<tUInt8> INST_reg13;
  MOD_Reg<tUInt8> INST_reg21;
  MOD_Reg<tUInt8> INST_reg22;
  MOD_Reg<tUInt8> INST_reg23;
  MOD_Reg<tUInt8> INST_reg31;
  MOD_Reg<tUInt8> INST_reg32;
  MOD_Reg<tUInt8> INST_reg33;
  MOD_Fifo<tUInt8> INST_rowBuffer_1;
  MOD_Fifo<tUInt8> INST_rowBuffer_2;
  MOD_Reg<tUInt8> INST_rowBuffer_inital;
  ...
  MOD_Reg<tUInt8> INST_slide;
  MOD_Reg<tUInt8> INST_slide_finish;
  MOD_Reg<tUInt32> INST_slide_position;
  MOD_Reg<tUInt8> INST_sobelConvert;
  MOD_Reg<tUInt8> INST_sobelState;
  MOD_Reg<tUInt64> INST_start;
  MOD_Reg<tUInt8> INST_start_write_request;
  MOD_Reg<tUInt64> INST_state_64;
  MOD_Reg<tUInt8> INST_state_temp;
  MOD_Fifo<tUInt8> INST_sum1Buffer;
  MOD_Fifo<tUInt8> INST_sum2Buffer;
  MOD_Reg<tUInt32> INST_sum_1;
  MOD_Reg<tUInt32> INST_sum_12;
  MOD_Reg<tUInt32> INST_sum_2;
  MOD_Fifo<tUInt8> INST_testslideWindow;
  MOD_Reg<tUInt8> INST_testslideWindow_control;
  MOD_Reg<tUInt8> INST_testslideWindow_count;
  MOD_Reg<tUInt32> INST_threshold;
  MOD_Reg<tUInt8> INST_windowBuffer_once_inital;
  MOD_Reg<tUInt8> INST_windowReady;
  MOD_Reg<tUInt8> INST_windowSlide;
  MOD_Reg<tUInt8> INST_window_Initial;
 ...
 public:
  ...
  tUInt8 DEF_master_write_isRst_isInReset__h3416;
  tUInt8 DEF_master_read_isRst_isInReset__h2640;
  tUInt8 DEF_slave_write_isRst_isInReset__h891;
  tUInt8 DEF_slave_read_isRst_isInReset__h102;
  ...
  tUInt64 DEF_x__h6476;
  tUInt64 DEF_x__h6470;
  tUInt8 DEF_x__h11419;
  tUInt8 DEF_x__h9219;
 ...
 private:
  ...
  tUWide DEF_master_read_out_first____d174;
  tUWide DEF_slave_read_out_first____d18;
  tUInt64 DEF_x__h12354;
  tUInt64 DEF_x__h6524;
  tUInt32 DEF_y__h11482;
  tUInt32 DEF_x__h11479;
  tUInt32 DEF_sum_12__h11198;
  tUInt32 DEF_sum_2__h10762;
  tUInt32 DEF_sum_1__h10674;
  tUInt8 DEF_b__h10429;
  tUInt8 DEF_b__h10421;
  tUInt8 DEF_b__h10413;
  tUInt8 DEF_b__h10405;
  tUInt8 DEF_b__h10397;
  tUInt8 DEF_b__h10389;
  tUInt8 DEF_b__h10381;
  tUInt8 DEF_b__h10373;
  tUWide DEF_master_write_in_first__1_BITS_74_TO_3___d95;
  tUWide DEF_slave_write_dataIn_rv_port1__read__4_BITS_71_TO_0___d32;
  tUInt32 DEF_y__h11480;
  tUInt8 DEF_x__h11235;
  tUInt8 DEF_x__h8782;
  tUWide DEF_slave_write_addrIn_rv_port1__read__2_BITS_66_T_ETC___d34;
  tUWide DEF_address_image_2_34_PLUS_ddr_write_count_80_81__ETC___d483;
  ...
  tUWide DEF_address_image_1_33_PLUS_ddr_read_count_65_66_C_ETC___d167;
 ...
 public:
  ...
  void RL_readRequest();
  void RL_localDataBuffer();
  void RL_localDataBuffer_8bit();
  void RL_rowBufferInital();
  void RL_rowBufferInital_finish();
  void RL_initial_testslideWindow();
  void RL_initial_testslideWindow_finish();
  void RL_windowBuffer_inital();
  void RL_windowBuffer_inital_2();
  void RL_windowBuffer_inital_3();
  void RL_windowBuffer_inital_end();
  void RL_windowBuffer_slide();
  void RL_sobelOperator();
  void RL_absSum1();
  void RL_sumUp();
  void RL_limitMagnitude();
  void RL_thresholdPixel();
  void RL_writePixel();
