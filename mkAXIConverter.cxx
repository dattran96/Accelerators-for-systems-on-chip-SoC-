 ...
 * 
 * On Sun Dec 27 10:40:32 UTC 2020
 * 
 */
...
MOD_mkAXIConverter::MOD_mkAXIConverter(tSimStateHdl simHdl, char const *name, Module *parent)
  : Module(simHdl, name, parent),
    ...
    INST_current_read_address(simHdl, "current_read_address", this, 64u, 0llu, (tUInt8)0u),
    INST_current_write_address(simHdl, "current_write_address", this, 64u, 0llu, (tUInt8)0u),
    ...
    DEF_master_read_out_first____d180(66u),
    ...
    DEF_address_image_2_34_PLUS_ddr_write_count_71_88__ETC___d190(139u),
...
void MOD_mkAXIConverter::init_symbols_0()
{
  ...
  init_symbol(&symbols[5u], "current_read_address", SYM_MODULE, &INST_current_read_address);
  init_symbol(&symbols[6u], "current_write_address", SYM_MODULE, &INST_current_write_address);
  init_symbol(&symbols[7u], "ddr_read_count", SYM_MODULE, &INST_ddr_read_count);
  init_symbol(&symbols[8u], "ddr_write_count", SYM_MODULE, &INST_ddr_write_count);
  init_symbol(&symbols[9u], "gray_data", SYM_MODULE, &INST_gray_data);
  init_symbol(&symbols[10u], "image_size", SYM_MODULE, &INST_image_size);
  init_symbol(&symbols[11u], "M00_AXI_araddr", SYM_PORT, &PORT_M00_AXI_araddr, 64u);
  init_symbol(&symbols[12u], "M00_AXI_arprot", SYM_PORT, &PORT_M00_AXI_arprot, 3u);
  init_symbol(&symbols[13u], "M00_AXI_arvalid", SYM_PORT, &PORT_M00_AXI_arvalid, 1u);
  init_symbol(&symbols[14u], "M00_AXI_awaddr", SYM_PORT, &PORT_M00_AXI_awaddr, 64u);
  init_symbol(&symbols[15u], "M00_AXI_awprot", SYM_PORT, &PORT_M00_AXI_awprot, 3u);
  init_symbol(&symbols[16u], "M00_AXI_awvalid", SYM_PORT, &PORT_M00_AXI_awvalid, 1u);
  init_symbol(&symbols[17u], "M00_AXI_bready", SYM_PORT, &PORT_M00_AXI_bready, 1u);
  init_symbol(&symbols[18u], "M00_AXI_rready", SYM_PORT, &PORT_M00_AXI_rready, 1u);
  init_symbol(&symbols[19u], "M00_AXI_wdata", SYM_PORT, &PORT_M00_AXI_wdata, 64u);
  init_symbol(&symbols[20u], "M00_AXI_wstrb", SYM_PORT, &PORT_M00_AXI_wstrb, 8u);
  init_symbol(&symbols[21u], "M00_AXI_wvalid", SYM_PORT, &PORT_M00_AXI_wvalid, 1u);
  init_symbol(&symbols[22u], "master_read_araddrOut", SYM_MODULE, &INST_master_read_araddrOut);
  init_symbol(&symbols[23u], "master_read_arprotOut", SYM_MODULE, &INST_master_read_arprotOut);
  init_symbol(&symbols[24u], "master_read_arreadyIn", SYM_MODULE, &INST_master_read_arreadyIn);
  init_symbol(&symbols[25u], "master_read_in", SYM_MODULE, &INST_master_read_in);
  ...
  init_symbol(&symbols[27u],
	      ...
	      1u);
  init_symbol(&symbols[28u], "master_read_out", SYM_MODULE, &INST_master_read_out);
  init_symbol(&symbols[29u], "master_read_rdataIn", SYM_MODULE, &INST_master_read_rdataIn);
  init_symbol(&symbols[30u], "master_read_rrespIn", SYM_MODULE, &INST_master_read_rrespIn);
  init_symbol(&symbols[31u], "master_read_rvalidIn", SYM_MODULE, &INST_master_read_rvalidIn);
  init_symbol(&symbols[32u], "master_write_addrOut_rv", SYM_MODULE, &INST_master_write_addrOut_rv);
  init_symbol(&symbols[33u], "master_write_awaddrOut", SYM_MODULE, &INST_master_write_awaddrOut);
  init_symbol(&symbols[34u], "master_write_awprotOut", SYM_MODULE, &INST_master_write_awprotOut);
  init_symbol(&symbols[35u], "master_write_awreadyIn", SYM_MODULE, &INST_master_write_awreadyIn);
  init_symbol(&symbols[36u], "master_write_brespIn", SYM_MODULE, &INST_master_write_brespIn);
  init_symbol(&symbols[37u], "master_write_bvalidIn", SYM_MODULE, &INST_master_write_bvalidIn);
  init_symbol(&symbols[38u], "master_write_dataOut_rv", SYM_MODULE, &INST_master_write_dataOut_rv);
  init_symbol(&symbols[39u], "master_write_in", SYM_MODULE, &INST_master_write_in);
  ...
  init_symbol(&symbols[41u],
	      ...
	      1u);
  init_symbol(&symbols[42u], "master_write_out", SYM_MODULE, &INST_master_write_out);
  init_symbol(&symbols[43u], "master_write_wdataOut", SYM_MODULE, &INST_master_write_wdataOut);
  init_symbol(&symbols[44u], "master_write_wreadyIn", SYM_MODULE, &INST_master_write_wreadyIn);
  init_symbol(&symbols[45u], "master_write_wstrbOut", SYM_MODULE, &INST_master_write_wstrbOut);
  init_symbol(&symbols[46u], "RDY_M00_AXI_araddr", SYM_PORT, &PORT_RDY_M00_AXI_araddr, 1u);
  init_symbol(&symbols[47u], "RDY_M00_AXI_arprot", SYM_PORT, &PORT_RDY_M00_AXI_arprot, 1u);
  init_symbol(&symbols[48u], "RDY_M00_AXI_arvalid", SYM_PORT, &PORT_RDY_M00_AXI_arvalid, 1u);
  init_symbol(&symbols[49u], "RDY_M00_AXI_awaddr", SYM_PORT, &PORT_RDY_M00_AXI_awaddr, 1u);
  init_symbol(&symbols[50u], "RDY_M00_AXI_awprot", SYM_PORT, &PORT_RDY_M00_AXI_awprot, 1u);
  init_symbol(&symbols[51u], "RDY_M00_AXI_awvalid", SYM_PORT, &PORT_RDY_M00_AXI_awvalid, 1u);
  init_symbol(&symbols[52u], "RDY_M00_AXI_bready", SYM_PORT, &PORT_RDY_M00_AXI_bready, 1u);
  init_symbol(&symbols[53u], "RDY_M00_AXI_parready", SYM_PORT, &PORT_RDY_M00_AXI_parready, 1u);
  init_symbol(&symbols[54u], "RDY_M00_AXI_pawready", SYM_PORT, &PORT_RDY_M00_AXI_pawready, 1u);
  init_symbol(&symbols[55u], "RDY_M00_AXI_pbresp", SYM_PORT, &PORT_RDY_M00_AXI_pbresp, 1u);
  init_symbol(&symbols[56u], "RDY_M00_AXI_pbvalid", SYM_PORT, &PORT_RDY_M00_AXI_pbvalid, 1u);
  init_symbol(&symbols[57u], "RDY_M00_AXI_prdata", SYM_PORT, &PORT_RDY_M00_AXI_prdata, 1u);
  init_symbol(&symbols[58u], "RDY_M00_AXI_prresp", SYM_PORT, &PORT_RDY_M00_AXI_prresp, 1u);
  init_symbol(&symbols[59u], "RDY_M00_AXI_prvalid", SYM_PORT, &PORT_RDY_M00_AXI_prvalid, 1u);
  init_symbol(&symbols[60u], "RDY_M00_AXI_pwready", SYM_PORT, &PORT_RDY_M00_AXI_pwready, 1u);
  init_symbol(&symbols[61u], "RDY_M00_AXI_rready", SYM_PORT, &PORT_RDY_M00_AXI_rready, 1u);
  init_symbol(&symbols[62u], "RDY_M00_AXI_wdata", SYM_PORT, &PORT_RDY_M00_AXI_wdata, 1u);
  init_symbol(&symbols[63u], "RDY_M00_AXI_wstrb", SYM_PORT, &PORT_RDY_M00_AXI_wstrb, 1u);
  init_symbol(&symbols[64u], "RDY_M00_AXI_wvalid", SYM_PORT, &PORT_RDY_M00_AXI_wvalid, 1u);
  init_symbol(&symbols[65u], "RDY_S00_AXI_arready", SYM_PORT, &PORT_RDY_S00_AXI_arready, 1u);
  init_symbol(&symbols[66u], "RDY_S00_AXI_awready", SYM_PORT, &PORT_RDY_S00_AXI_awready, 1u);
  init_symbol(&symbols[67u], "RDY_S00_AXI_bresp", SYM_PORT, &PORT_RDY_S00_AXI_bresp, 1u);
  init_symbol(&symbols[68u], "RDY_S00_AXI_bvalid", SYM_PORT, &PORT_RDY_S00_AXI_bvalid, 1u);
  init_symbol(&symbols[69u], "RDY_S00_AXI_paraddr", SYM_PORT, &PORT_RDY_S00_AXI_paraddr, 1u);
  init_symbol(&symbols[70u], "RDY_S00_AXI_parprot", SYM_PORT, &PORT_RDY_S00_AXI_parprot, 1u);
  init_symbol(&symbols[71u], "RDY_S00_AXI_parvalid", SYM_PORT, &PORT_RDY_S00_AXI_parvalid, 1u);
  init_symbol(&symbols[72u], "RDY_S00_AXI_pawaddr", SYM_PORT, &PORT_RDY_S00_AXI_pawaddr, 1u);
  init_symbol(&symbols[73u], "RDY_S00_AXI_pawprot", SYM_PORT, &PORT_RDY_S00_AXI_pawprot, 1u);
  init_symbol(&symbols[74u], "RDY_S00_AXI_pawvalid", SYM_PORT, &PORT_RDY_S00_AXI_pawvalid, 1u);
  init_symbol(&symbols[75u], "RDY_S00_AXI_pbready", SYM_PORT, &PORT_RDY_S00_AXI_pbready, 1u);
  init_symbol(&symbols[76u], "RDY_S00_AXI_prready", SYM_PORT, &PORT_RDY_S00_AXI_prready, 1u);
  init_symbol(&symbols[77u], "RDY_S00_AXI_pwdata", SYM_PORT, &PORT_RDY_S00_AXI_pwdata, 1u);
  init_symbol(&symbols[78u], "RDY_S00_AXI_pwstrb", SYM_PORT, &PORT_RDY_S00_AXI_pwstrb, 1u);
  init_symbol(&symbols[79u], "RDY_S00_AXI_pwvalid", SYM_PORT, &PORT_RDY_S00_AXI_pwvalid, 1u);
  init_symbol(&symbols[80u], "RDY_S00_AXI_rdata", SYM_PORT, &PORT_RDY_S00_AXI_rdata, 1u);
  init_symbol(&symbols[81u], "RDY_S00_AXI_rresp", SYM_PORT, &PORT_RDY_S00_AXI_rresp, 1u);
  init_symbol(&symbols[82u], "RDY_S00_AXI_rvalid", SYM_PORT, &PORT_RDY_S00_AXI_rvalid, 1u);
  init_symbol(&symbols[83u], "RDY_S00_AXI_wready", SYM_PORT, &PORT_RDY_S00_AXI_wready, 1u);
  init_symbol(&symbols[84u], "RL_convertRGB2Gray", SYM_RULE);
  init_symbol(&symbols[85u], "RL_handleReadRequest", SYM_RULE);
  init_symbol(&symbols[86u], "RL_handleWriteRequest", SYM_RULE);
  init_symbol(&symbols[87u], "RL_master_read_deqIn", SYM_RULE);
  init_symbol(&symbols[88u], "RL_master_read_enqOut", SYM_RULE);
  init_symbol(&symbols[89u], "RL_master_read_forwardIn", SYM_RULE);
  init_symbol(&symbols[90u], "RL_master_read_isRst_isResetAssertedUpdate", SYM_RULE);
  init_symbol(&symbols[91u], "RL_master_write_deqAddr", SYM_RULE);
  init_symbol(&symbols[92u], "RL_master_write_deqData", SYM_RULE);
  init_symbol(&symbols[93u], "RL_master_write_forwardAddr", SYM_RULE);
  init_symbol(&symbols[94u], "RL_master_write_forwardData", SYM_RULE);
  init_symbol(&symbols[95u], "RL_master_write_forwardResp", SYM_RULE);
  init_symbol(&symbols[96u], "RL_master_write_isRst_isResetAssertedUpdate", SYM_RULE);
  init_symbol(&symbols[97u], "RL_master_write_splitAddrData", SYM_RULE);
  init_symbol(&symbols[98u], "RL_readRequest", SYM_RULE);
  init_symbol(&symbols[99u], "RL_slave_read_addrInWrite", SYM_RULE);
  init_symbol(&symbols[100u], "RL_slave_read_deqOut", SYM_RULE);
  init_symbol(&symbols[101u], "RL_slave_read_isRst_isResetAssertedUpdate", SYM_RULE);
  init_symbol(&symbols[102u], "RL_slave_read_putOutData", SYM_RULE);
  init_symbol(&symbols[103u], "RL_slave_write_addrInWrite", SYM_RULE);
  init_symbol(&symbols[104u], "RL_slave_write_dataInWrite", SYM_RULE);
  init_symbol(&symbols[105u], "RL_slave_write_isRst_isResetAssertedUpdate", SYM_RULE);
  init_symbol(&symbols[106u], "RL_slave_write_mergeAddrData", SYM_RULE);
  init_symbol(&symbols[107u], "RL_slave_write_outForward", SYM_RULE);
  init_symbol(&symbols[108u], "RL_slave_write_outWrite", SYM_RULE);
  init_symbol(&symbols[109u], "RL_writeRequest", SYM_RULE);
  init_symbol(&symbols[110u], "S00_AXI_arready", SYM_PORT, &PORT_S00_AXI_arready, 1u);
  init_symbol(&symbols[111u], "S00_AXI_awready", SYM_PORT, &PORT_S00_AXI_awready, 1u);
  init_symbol(&symbols[112u], "S00_AXI_bresp", SYM_PORT, &PORT_S00_AXI_bresp, 2u);
  init_symbol(&symbols[113u], "S00_AXI_bvalid", SYM_PORT, &PORT_S00_AXI_bvalid, 1u);
  init_symbol(&symbols[114u], "S00_AXI_rdata", SYM_PORT, &PORT_S00_AXI_rdata, 64u);
  init_symbol(&symbols[115u], "S00_AXI_rresp", SYM_PORT, &PORT_S00_AXI_rresp, 2u);
  init_symbol(&symbols[116u], "S00_AXI_rvalid", SYM_PORT, &PORT_S00_AXI_rvalid, 1u);
  init_symbol(&symbols[117u], "S00_AXI_wready", SYM_PORT, &PORT_S00_AXI_wready, 1u);
  init_symbol(&symbols[118u], "slave_read_araddrIn", SYM_MODULE, &INST_slave_read_araddrIn);
  init_symbol(&symbols[119u], "slave_read_arprotIn", SYM_MODULE, &INST_slave_read_arprotIn);
  init_symbol(&symbols[120u], "slave_read_arvalidIn", SYM_MODULE, &INST_slave_read_arvalidIn);
  init_symbol(&symbols[121u], "slave_read_in", SYM_MODULE, &INST_slave_read_in);
  ...
  init_symbol(&symbols[123u],
	      ...
	      1u);
  init_symbol(&symbols[124u], "slave_read_out", SYM_MODULE, &INST_slave_read_out);
  init_symbol(&symbols[125u], "slave_read_rdataOut", SYM_MODULE, &INST_slave_read_rdataOut);
  init_symbol(&symbols[126u], "slave_read_rreadyIn", SYM_MODULE, &INST_slave_read_rreadyIn);
  init_symbol(&symbols[127u], "slave_read_rrespOut", SYM_MODULE, &INST_slave_read_rrespOut);
  init_symbol(&symbols[128u], "slave_write_addrIn_rv", SYM_MODULE, &INST_slave_write_addrIn_rv);
  init_symbol(&symbols[129u], "slave_write_awaddrIn", SYM_MODULE, &INST_slave_write_awaddrIn);
  init_symbol(&symbols[130u], "slave_write_awprotIn", SYM_MODULE, &INST_slave_write_awprotIn);
  init_symbol(&symbols[131u], "slave_write_awvalidIn", SYM_MODULE, &INST_slave_write_awvalidIn);
  init_symbol(&symbols[132u], "slave_write_breadyIn", SYM_MODULE, &INST_slave_write_breadyIn);
  init_symbol(&symbols[133u], "slave_write_brespOut", SYM_MODULE, &INST_slave_write_brespOut);
  init_symbol(&symbols[134u], "slave_write_dataIn_rv", SYM_MODULE, &INST_slave_write_dataIn_rv);
  init_symbol(&symbols[135u], "slave_write_in", SYM_MODULE, &INST_slave_write_in);
  ...
  init_symbol(&symbols[137u],
	      ...
	      1u);
  init_symbol(&symbols[138u], "slave_write_out", SYM_MODULE, &INST_slave_write_out);
  init_symbol(&symbols[139u], "slave_write_wdataIn", SYM_MODULE, &INST_slave_write_wdataIn);
  init_symbol(&symbols[140u], "slave_write_wstrbIn", SYM_MODULE, &INST_slave_write_wstrbIn);
  init_symbol(&symbols[141u], "slave_write_wvalidIn", SYM_MODULE, &INST_slave_write_wvalidIn);
  init_symbol(&symbols[142u], "start", SYM_MODULE, &INST_start);
  init_symbol(&symbols[143u], "start_write_request", SYM_MODULE, &INST_start_write_request);
  init_symbol(&symbols[144u], "x__h6361", SYM_DEF, &DEF_x__h6361, 64u);
  init_symbol(&symbols[145u], "x__h6367", SYM_DEF, &DEF_x__h6367, 64u);
}
...
void MOD_mkAXIConverter::RL_handleReadRequest()
{
  ...
  DEF_x__h6367 = INST_conversion_finished.METH_read();
  DEF_x__h6361 = INST_start.METH_read();
  DEF_x__h6735 = INST_address_image_2.METH_read();
  DEF_x__h5648 = DEF_slave_read_in_first____d122.get_bits_in_word8(0u, 3u, 6u);
  DEF_x__h6419 = INST_address_image_1.METH_read();
  DEF_x_data__h5943 = DEF_x__h6419 + DEF_x__h6735;
  switch (DEF_x__h5648) {
  case (tUInt8)0u:
    DEF_IF_slave_read_in_first__22_BITS_8_TO_3_23_EQ_0_ETC___d141 = DEF_x__h6419;
    break;
  case (tUInt8)8u:
    DEF_IF_slave_read_in_first__22_BITS_8_TO_3_23_EQ_0_ETC___d141 = DEF_x__h6735;
    break;
  case (tUInt8)16u:
    DEF_IF_slave_read_in_first__22_BITS_8_TO_3_23_EQ_0_ETC___d141 = DEF_x__h6361;
    break;
  case (tUInt8)24u:
    DEF_IF_slave_read_in_first__22_BITS_8_TO_3_23_EQ_0_ETC___d141 = DEF_x__h6367;
    break;
  default:
...
void MOD_mkAXIConverter::RL_handleWriteRequest()
{
  ...
  tUInt8 DEF_x__h6032;
  tUInt64 DEF_x__h6168;
  DEF_slave_write_in_first____d149 = INST_slave_write_in.METH_first();
  DEF_x__h6168 = primExtract64(64u, 139u, DEF_slave_write_in_first____d149, 32u, 74u, 32u, 11u);
  DEF_x__h6032 = DEF_slave_write_in_first____d149.get_bits_in_word8(2u, 11u, 6u);
  DEF_slave_write_in_first__49_BITS_80_TO_75_50_EQ_32___d154 = DEF_x__h6032 == (tUInt8)32u;
  DEF_slave_write_in_first__49_BITS_80_TO_75_50_EQ_16___d153 = DEF_x__h6032 == (tUInt8)16u;
  DEF_slave_write_in_first__49_BITS_80_TO_75_50_EQ_8___d152 = DEF_x__h6032 == (tUInt8)8u;
  DEF_slave_write_in_first__49_BITS_80_TO_75_50_EQ_0___d151 = DEF_x__h6032 == (tUInt8)0u;
...
{
  tUInt64 DEF_addr__h6387;
  tUInt64 DEF_x__h6503;
  tUInt64 DEF_IF_ddr_write_count_71_EQ_98304_72_THEN_0_ELSE__ETC___d174;
  tUInt64 DEF_x__h6513;
  DEF_x__h6927 = INST_ddr_write_count.METH_read();
  DEF_x__h6513 = INST_ddr_read_count.METH_read();
  DEF_x__h6419 = INST_address_image_1.METH_read();
  DEF_ddr_write_count_71_EQ_98304___d172 = DEF_x__h6927 == 98304llu;
  DEF_x__h6503 = DEF_x__h6513 + 8llu;
  DEF_IF_ddr_write_count_71_EQ_98304_72_THEN_0_ELSE__ETC___d174 = DEF_ddr_write_count_71_EQ_98304___d172 ? 0llu : DEF_x__h6503;
  DEF_addr__h6387 = DEF_x__h6419 + DEF_x__h6513;
  DEF_address_image_1_33_PLUS_ddr_read_count_68_69_C_ETC___d170.set_bits_in_word((tUInt8)(DEF_addr__h6387 >> 61u),
										 2u,
										 0u,
										 3u).set_whole_word((tUInt32)(DEF_addr__h6387 >> 29u),
												    1u).set_whole_word((((tUInt32)(536870911u & DEF_addr__h6387)) << 3u) | (tUInt32)((tUInt8)0u),
														       0u);
  INST_master_read_in.METH_enq(DEF_address_image_1_33_PLUS_ddr_read_count_68_69_C_ETC___d170);
  INST_ddr_read_count.METH_write(DEF_IF_ddr_write_count_71_EQ_98304_72_THEN_0_ELSE__ETC___d174);
  INST_converting_flag.METH_write((tUInt8)1u);
}

void MOD_mkAXIConverter::RL_convertRGB2Gray()
{
  tUInt64 DEF_v__h6566;
  DEF_master_read_out_first____d180 = INST_master_read_out.METH_first();
  DEF_v__h6566 = primExtract64(64u, 66u, DEF_master_read_out_first____d180, 32u, 65u, 32u, 2u);
  INST_master_read_out.METH_deq();
  INST_buffer.METH_enq(DEF_v__h6566);
  INST_start_write_request.METH_write((tUInt8)1u);
}

void MOD_mkAXIConverter::RL_writeRequest()
{
  tUInt64 DEF_addr__h6716;
  tUInt64 DEF_x__h6917;
  tUInt64 DEF_IF_ddr_write_count_71_EQ_98304_72_THEN_0_ELSE__ETC___d192;
  tUInt64 DEF_data__h6717;
  DEF_x__h6927 = INST_ddr_write_count.METH_read();
  DEF_data__h6717 = INST_buffer.METH_first();
  DEF_x__h6735 = INST_address_image_2.METH_read();
  DEF_ddr_write_count_71_EQ_98304___d172 = DEF_x__h6927 == 98304llu;
  DEF_x__h6917 = DEF_x__h6927 + 8llu;
  DEF_IF_ddr_write_count_71_EQ_98304_72_THEN_0_ELSE__ETC___d192 = DEF_ddr_write_count_71_EQ_98304___d172 ? 0llu : DEF_x__h6917;
  DEF_addr__h6716 = DEF_x__h6735 + DEF_x__h6927;
  DEF_address_image_2_34_PLUS_ddr_write_count_71_88__ETC___d190.set_bits_in_word((tUInt32)(DEF_addr__h6716 >> 53u),
										 4u,
										 0u,
										 11u).set_whole_word((tUInt32)(DEF_addr__h6716 >> 21u),
												     3u).set_whole_word((((tUInt32)(2097151u & DEF_addr__h6716)) << 11u) | (tUInt32)(DEF_data__h6717 >> 53u),
															2u).set_whole_word((tUInt32)(DEF_data__h6717 >> 21u),
																	   1u).set_whole_word((((tUInt32)(2097151u & DEF_data__h6717)) << 11u) | 2040u,
																			      0u);
  INST_master_write_in.METH_enq(DEF_address_image_2_34_PLUS_ddr_write_count_71_88__ETC___d190);
  INST_buffer.METH_deq();
  INST_ddr_write_count.METH_write(DEF_IF_ddr_write_count_71_EQ_98304_72_THEN_0_ELSE__ETC___d192);
  if (DEF_ddr_write_count_71_EQ_98304___d172)
    INST_conversion_finished.METH_write(1llu);
  if (DEF_ddr_write_count_71_EQ_98304___d172)
    INST_start.METH_write(0llu);
  INST_start_write_request.METH_write((tUInt8)0u);
...
void MOD_mkAXIConverter::reset_aresetn(tUInt8 ARG_rst_in)
{
  ...
  INST_current_write_address.reset_RST(ARG_rst_in);
  INST_current_read_address.reset_RST(ARG_rst_in);
...
void MOD_mkAXIConverter::dump_state(unsigned int indent)
{
  ...
  INST_current_read_address.dump_state(indent + 2u);
  INST_current_write_address.dump_state(indent + 2u);
...
unsigned int MOD_mkAXIConverter::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "address_image_2_34_PLUS_ddr_write_count_71_88__ETC___d190", 139u);
  vcd_write_def(sim_hdl, num++, "aresetn", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "ddr_write_count_71_EQ_98304___d172", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "master_read_out_first____d180", 66u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h6361", 64u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h6367", 64u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h6419", 64u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h6735", 64u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h6927", 64u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  num = INST_current_read_address.dump_VCD_defs(num);
  num = INST_current_write_address.dump_VCD_defs(num);
...
void MOD_mkAXIConverter::vcd_defs(tVCDDumpType dt, MOD_mkAXIConverter &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.DEF_address_image_1_33_PLUS_ddr_read_count_68_69_C_ETC___d170 = DEF_address_image_1_33_PLUS_ddr_read_count_68_69_C_ETC___d170;
      ...
      ++num;
      if ((backing.DEF_address_image_2_34_PLUS_ddr_write_count_71_88__ETC___d190) != DEF_address_image_2_34_PLUS_ddr_write_count_71_88__ETC___d190)
      {
	vcd_write_val(sim_hdl, num, DEF_address_image_2_34_PLUS_ddr_write_count_71_88__ETC___d190, 139u);
	backing.DEF_address_image_2_34_PLUS_ddr_write_count_71_88__ETC___d190 = DEF_address_image_2_34_PLUS_ddr_write_count_71_88__ETC___d190;
      }
      ++num;
	...
	backing.PORT_aresetn = PORT_aresetn;
      ...
      ++num;
      if ((backing.DEF_ddr_write_count_71_EQ_98304___d172) != DEF_ddr_write_count_71_EQ_98304___d172)
      {
	vcd_write_val(sim_hdl, num, DEF_ddr_write_count_71_EQ_98304___d172, 1u);
	backing.DEF_ddr_write_count_71_EQ_98304___d172 = DEF_ddr_write_count_71_EQ_98304___d172;
      }
      ++num;
	...
	backing.DEF_master_read_isRst_isInReset__h2620 = DEF_master_read_isRst_isInReset__h2620;
      ...
      ++num;
      if ((backing.DEF_master_read_out_first____d180) != DEF_master_read_out_first____d180)
      {
	vcd_write_val(sim_hdl, num, DEF_master_read_out_first____d180, 66u);
	backing.DEF_master_read_out_first____d180 = DEF_master_read_out_first____d180;
      }
      ++num;
	...
	backing.DEF_slave_write_out_notEmpty____d57 = DEF_slave_write_out_notEmpty____d57;
      ...
      ++num;
      if ((backing.DEF_x__h6361) != DEF_x__h6361)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h6361, 64u);
	backing.DEF_x__h6361 = DEF_x__h6361;
      }
      ++num;
      if ((backing.DEF_x__h6367) != DEF_x__h6367)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h6367, 64u);
	backing.DEF_x__h6367 = DEF_x__h6367;
      }
      ++num;
      if ((backing.DEF_x__h6419) != DEF_x__h6419)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h6419, 64u);
	backing.DEF_x__h6419 = DEF_x__h6419;
      }
      ++num;
      if ((backing.DEF_x__h6735) != DEF_x__h6735)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h6735, 64u);
	backing.DEF_x__h6735 = DEF_x__h6735;
      }
      ++num;
      if ((backing.DEF_x__h6927) != DEF_x__h6927)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h6927, 64u);
	backing.DEF_x__h6927 = DEF_x__h6927;
      }
      ++num;
...
void MOD_mkAXIConverter::vcd_prims(tVCDDumpType dt, MOD_mkAXIConverter &backing)
{
  ...
  INST_current_read_address.dump_VCD(dt, backing.INST_current_read_address);
  INST_current_write_address.dump_VCD(dt, backing.INST_current_write_address);
